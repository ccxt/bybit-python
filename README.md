...
- `fetch_option_markets(self, params: Any)`
...
- `add_pagination_cursor_to_result(self, response: Any)`
...
- `get_bybit_type(self, method: Any, market: Any, params={})`
...
- `watch_topics(self, url: Any, messageHashes: Any, topics: Any, params={})`
- `un_watch_topics(self, url: str, topic: str, symbols: Strings, messageHashes: List[str], subMessageHashes: List[str], topics: Any, params={}, subExtension={})`
- `authenticate(self, url: Any, params={})`
