...
- `create_convert_trade(self, id: str, fromCode: str, toCode: str, amount: Num = None, params: dict = {})`
- `create_expired_option_market(self, symbol: str)`
- `create_market_buy_order_with_cost(self, symbol: str, cost: float, params: dict = {})`
- `create_market_sell_order_with_cost(self, symbol: str, cost: float, params: dict = {})`
- `create_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params: dict = {}, isUTA: Bool = True)`
...
- `fetch_all_greeks(self, symbols: Strings = None, params: dict = {})`
- `fetch_balance(self, params: dict = {})`
- `fetch_bids_asks(self, symbols: Strings = None, params: dict = {})`
- `fetch_borrow_interest(self, code: Str = None, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_borrow_rate_history(self, code: str, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_canceled_and_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_canceled_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_closed_order(self, id: str, symbol: Str = None, params: dict = {})`
- `fetch_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_convert_currencies(self, params: dict = {})`
- `fetch_convert_quote(self, fromCode: str, toCode: str, amount: Num = None, params: dict = {})`
- `fetch_convert_trade_history(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_convert_trade(self, id: str, code: Str = None, params: dict = {})`
- `fetch_cross_borrow_rate(self, code: str, params: dict = {})`
- `fetch_currencies(self, params: dict = {})`
- `fetch_deposit_address(self, code: str, params: dict = {})`
- `fetch_deposit_addresses_by_network(self, code: str, params: dict = {})`
...
- `fetch_derivatives_market_leverage_tiers(self, symbol: str, params: dict = {})`
- `fetch_derivatives_open_interest_history(self, symbol: str, timeframe: Str = '1h', since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_future_markets(self, params: dict = {})`
- `fetch_greeks(self, symbol: str, params: dict = {})`
...
- `fetch_long_short_ratio_history(self, symbol: Str = None, timeframe: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_margin_mode(self, symbol: str, params: dict = {})`
- `fetch_market_leverage_tiers(self, symbol: str, params: dict = {})`
- `fetch_markets(self, params: dict = {})`
- `fetch_my_liquidations(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_my_settlement_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_open_interest_history(self, symbol: str, timeframe='1h', since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_open_interest(self, symbol: str, params: dict = {})`
- `fetch_open_order(self, id: str, symbol: Str = None, params: dict = {})`
- `fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_option_chain(self, code: str, params: dict = {})`
- `fetch_option_markets(self, params: object)`
- `fetch_option(self, symbol: str, params: dict = {})`
- `fetch_order_book(self, symbol: str, limit: Int = None, params: dict = {})`
- `fetch_order_classic(self, id: str, symbol: Str = None, params: dict = {})`
...
- `fetch_orders_classic(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_position(self, symbol: str, params: dict = {})`
- `fetch_positions_adl_rank(self, symbols: Strings = None, params: dict = {})`
- `fetch_positions_history(self, symbols: Strings = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_positions(self, symbols: Strings = None, params: dict = {})`
- `fetch_settlement_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_volatility_history(self, code: str, params: dict = {})`
- `fetch_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `add_pagination_cursor_to_result(self, response: dict)`
- `borrow_cross_margin(self, code: str, amount: float, params: dict = {})`
- `cancel_all_orders_after(self, timeout: Int, params: dict = {})`
- `cancel_all_orders(self, symbol: Str = None, params: dict = {})`
- `cancel_order_request(self, id: str, symbol: Str = None, params: dict = {})`
- `cancel_order(self, id: str, symbol: Str = None, params: dict = {})`
- `cancel_orders_for_symbols(self, orders: list[CancellationRequest], params: dict = {})`
- `cancel_orders(self, ids: list[str], symbol: Str = None, params: dict = {})`
- `describe(self)`
- `edit_order_request(self, id: Str, symbol: Str, type: Str, side: Str, amount: Num = None, price: Num = None, params: dict = {})`
...
- `get_amount(self, symbol: Str, amount: float | None)`
- `get_bybit_type(self, method: object, market: object, params: dict = {})`
- `get_cost(self, symbol: Str, cost: Str)`
- `get_leverage_tiers_paginated(self, symbol: Str = None, params: dict = {})`
- `get_price(self, symbol: Str, price: object)`
- `is_unified_enabled(self, params: dict = {})`
- `nonce(self)`
- `repay_cross_margin(self, code: str, amount: float, params: dict = {})`
...
- `set_position_mode(self, hedged: bool, symbol: Str = None, params: dict = {})`
- `transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params: dict = {})`
- `upgrade_unified_trade_account(self, params: dict = {})`
...
- `public_get_v5_system_status(request)`
...
- `public_get_v5_market_rpi_orderbook(request)`
- `public_get_v5_market_full_orderbook(request)`
...
- `public_get_v5_market_new_delivery_price(request)`
- `public_get_v5_market_account_ratio(request)`
- `public_get_v5_market_index_price_components(request)`
- `public_get_v5_market_price_limit(request)`
- `public_get_v5_market_adlalert(request)`
- `public_get_v5_market_fee_group_info(request)`
...
- `public_get_v5_spot_x_launchpool_project_list(request)`
- `public_get_v5_spot_x_puzzle_project_list(request)`
- `public_get_v5_spot_x_token_splash_project_list(request)`
- `public_get_v5_event_instruments_info(request)`
- `public_get_v5_event_orderbook(request)`
...
- `private_get_v5_position_get_closed_positions(request)`
- `private_get_v5_position_move_history(request)`
- `private_get_v5_position_symbol_info(request)`
...
- `private_get_v5_account_option_asset_info(request)`
...
- `private_get_v5_account_query_dcp_info(request)`
- `private_get_v5_account_user_setting_config(request)`
- `private_get_v5_account_pay_info(request)`
- `private_get_v5_account_trade_info_for_analysis(request)`
...
- `private_get_v5_asset_asset_overview(request)`
...
- `private_get_v5_asset_fundinghistory(request)`
- `private_get_v5_asset_portfolio_margin(request)`
- `private_get_v5_asset_total_members_assets(request)`
...
- `private_get_v5_asset_covert_small_balance_list(request)`
- `private_get_v5_asset_covert_small_balance_history(request)`
...
- `private_get_v5_user_escrow_sub_members(request)`
- `private_get_v5_user_invitation_referrals(request)`
- `private_get_v5_user_invitation_code(request)`
- `private_get_v5_affiliate_aff_user_list(request)`
- `private_get_v5_affiliate_affiliate_sub_list(request)`
- `private_get_v5_spot_lever_token_order_record(request)`
- `private_get_v5_spot_margin_trade_flexible_available_inventory(request)`
- `private_get_v5_spot_margin_trade_fixed_available_inventory(request)`
...
- `private_get_v5_spot_margin_trade_currency_data(request)`
- `private_get_v5_spot_margin_trade_fixedborrow_contract_info(request)`
- `private_get_v5_spot_margin_trade_fixedborrow_order_info(request)`
- `private_get_v5_spot_margin_trade_fixedborrow_order_quote(request)`
- `private_get_v5_spot_margin_trade_liability(request)`
...
- `private_get_v5_crypto_loan_fixed_available_inventory(request)`
- `private_get_v5_crypto_loan_flexible_available_inventory(request)`
- `private_get_v5_ins_loan_product_infos(request)`
- `private_get_v5_ins_loan_ensure_tokens(request)`
...
- `private_get_v5_ins_loan_ltv(request)`
- `private_get_v5_ins_loan_ltv_convert(request)`
- `private_get_v5_ins_loan_coin_delta_amount(request)`
...
- `private_get_v5_event_order_realtime(request)`
- `private_get_v5_event_order_list(request)`
- `private_get_v5_event_positions(request)`
- `private_get_v5_event_trades(request)`
- `private_get_v5_event_settlements(request)`
- `private_get_v5_spot_x_launchpool_user_current_staking(request)`
- `private_get_v5_spot_x_token_splash_user_activity_params(request)`
- `private_get_v5_rfq_rfq_detail_list(request)`
- `private_get_v5_alpha_prediction_engine_status(request)`
- `private_get_v5_alpha_prediction_pay_token_list(request)`
- `private_get_v5_alpha_prediction_sports_timeline_stages(request)`
...
- `private_post_v5_order_pre_check(request)`
...
- `private_post_v5_account_set_delta_mode(request)`
...
- `private_post_v5_asset_travel_rule_deposit_submit(request)`
...
- `private_post_v5_user_agreement(request)`
- `private_post_v5_user_create_demo_member(request)`
...
- `private_post_v5_spot_margin_trade_fixedborrow(request)`
- `private_post_v5_spot_margin_trade_fixedborrow_renew(request)`
...
- `private_post_v5_event_quotes(request)`
- `private_post_v5_event_cancel(request)`
- `private_post_v5_spot_x_launchpool_user_activity_log(request)`
- `private_post_v5_spot_x_launchpool_user_history(request)`
- `private_post_v5_alpha_prediction_event_detail(request)`
- `private_post_v5_alpha_prediction_order_estimate(request)`
- `private_post_v5_alpha_prediction_buy(request)`
- `private_post_v5_alpha_prediction_sell(request)`
- `private_post_v5_alpha_prediction_order_list(request)`
- `private_post_v5_alpha_prediction_order_book(request)`
- `private_post_v5_alpha_prediction_token_price(request)`
- `private_post_v5_alpha_prediction_price_history(request)`
- `private_post_v5_alpha_prediction_position_list(request)`
- `private_post_v5_alpha_prediction_position_history(request)`
- `private_post_v5_alpha_prediction_portfolio_summary(request)`
- `private_post_v5_alpha_prediction_side_market_list(request)`
- `private_post_v5_alpha_prediction_sports_match_list(request)`
- `private_post_v5_alpha_prediction_sports_group_stage_detail(request)`

### WS Unified

- `describe(self)`
- `describe_data(self)`
- `get_url_by_market_type(self, symbol: Str = None, isPrivate: Bool = False, method: Str = None, params: dict = {})`
- `clean_params(self, params: dict)`
- `create_order_ws(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params: dict = {})`
- `edit_order_ws(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params: dict = {})`
- `cancel_order_ws(self, id: str, symbol: Str = None, params: dict = {})`
...
- `watch_ohlcv_for_symbols(self, symbolsAndTimeframes: list[list[str]], since: Int = None, limit: Int = None, params: dict = {})`
- `un_watch_ohlcv_for_symbols(self, symbolsAndTimeframes: list[list[str]], params={})`
- `un_watch_ohlcv(self, symbol: str, timeframe: str = '1m', params: dict = {})`
...
- `watch_liquidations(self, symbol: str, since: Int = None, limit: Int = None, params: dict = {})`
...
- `watch_topics(self, url: str, messageHashes: list[str], topics: object, params: dict = {})`
- `un_watch_topics(self, url: str, topic: str, symbols: Strings, messageHashes: list[str], subMessageHashes: list[str], topics: object, params: dict = {}, subExtension: dict = {})`
- `authenticate(self, url: str, params: dict = {})`
