...
- `create_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params={}, isUTA=True)`
...
- `add_pagination_cursor_to_result(self, response: object)`
...
- `describe(self)`
- `edit_order_request(self, id: Str, symbol: Str, type: Str, side: Str, amount: Num = None, price: Num = None, params={})`
...
- `get_bybit_type(self, method: object, market: object, params={})`
...
- `nonce(self)`
- `repay_cross_margin(self, code: str, amount: float, params={})`
...
- `clean_params(self, params: object)`
...
- `get_private_type(self, url: object)`
...
- `watch_topics(self, url: object, messageHashes: object, topics: object, params={})`
- `un_watch_topics(self, url: str, topic: str, symbols: Strings, messageHashes: list[str], subMessageHashes: list[str], topics: object, params={}, subExtension={})`
- `authenticate(self, url: object, params={})`
